...
const EnrollInfoByOCR = ({ route, navigation }) => {
  ...
  const handleNext = async () => {
    ...
    const mappedCategoryForAnalytics = mappedCategory.toLowerCase();
    ...
    if (isFormValid()) {
        ...
        analytics().logEvent('ticket_camera_info',{category: mappedCategoryForAnalytics, time: unixTime, place: location, place_zone: locationDetail, place_seat: seats})
    } else {
