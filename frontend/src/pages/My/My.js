        ...
        <View style={styles.mainContent}>
          ...
          <View>
            ...
            <View style={styles.locationContainer}>
              <Text style={styles.locationText}>영화관 <Text style={{color: '#5D70F9', fontWeight: 700, fontSize: 22}}> 121 </Text>곳</Text>
              <Text style={styles.locationText}>공연장 <Text style={{color: '#5D70F9', fontWeight: 700, fontSize: 22}}> 121 </Text>곳</Text>
              <Text style={styles.locationText}>경기장 <Text style={{color: '#5D70F9', fontWeight: 700, fontSize: 22}}> 121 </Text>곳</Text>
            </View>
          </View>
        </View>
      </ScrollView>
